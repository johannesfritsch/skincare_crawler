...
import { kauflandDriver } from './drivers/kaufland'

const drivers: SourceDriver[] = [dmDriver, rossmannDriver, muellerDriver, purishDriver, douglasDriver, shopApothekeDriver, kauflandDriver]
