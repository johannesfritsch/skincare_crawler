...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_product_variants_images_source" ADD VALUE 'douglas';
  ALTER TYPE "public"."enum_source_products_source" ADD VALUE 'douglas';
  ALTER TYPE "public"."enum_source_brands_source" ADD VALUE 'douglas';
  ALTER TYPE "public"."enum_source_review_origins_source" ADD VALUE 'douglas';
  ALTER TYPE "public"."enum_product_searches_sources" ADD VALUE 'douglas';
  ALTER TYPE "public"."enum_product_crawls_source" ADD VALUE 'douglas';
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "product_aggregations" ALTER COLUMN "image_source_priority" SET DEFAULT '["dm","rossmann","mueller","purish"]'::jsonb;`)
}
