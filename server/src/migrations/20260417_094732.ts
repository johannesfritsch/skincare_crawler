...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_test_suites_searches_sources" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_product_variants_images_source" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_source_products_source" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_source_brands_source" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_source_review_origins_source" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_product_searches_sources" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TYPE "public"."enum_product_crawls_source" ADD VALUE IF NOT EXISTS 'kaufland';
  ALTER TABLE "product_aggregations" ALTER COLUMN "image_source_priority" SET DEFAULT '["dm","rossmann","mueller","purish","douglas","shopapotheke","kaufland"]'::jsonb;`)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "test_suites_searches_sources" ALTER COLUMN "value" SET DATA TYPE text;
  ...
  ALTER TABLE "test_suites_searches_sources" ALTER COLUMN "value" SET DATA TYPE "public"."enum_test_suites_searches_sources" USING "value"::"public"."enum_test_suites_searches_sources";
  ...
  CREATE TYPE "public"."enum_product_variants_images_source" AS ENUM('dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
  ...
  CREATE TYPE "public"."enum_source_products_source" AS ENUM('dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
  ...
  CREATE TYPE "public"."enum_source_brands_source" AS ENUM('dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
  ...
  CREATE TYPE "public"."enum_source_review_origins_source" AS ENUM('dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
  ...
  CREATE TYPE "public"."enum_product_searches_sources" AS ENUM('dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
  ...
  CREATE TYPE "public"."enum_product_crawls_source" AS ENUM('all', 'dm', 'rossmann', 'mueller', 'purish', 'douglas', 'shopapotheke');
